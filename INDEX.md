...
| **GAP#20260603-04** | **Add Node Runtime to Ping API**: The `/api/ping` endpoint should return a `runtime` field (e.g., `Node.js v24.15.0`) using `process.version` to aid in runtime verification. |   5    |    8    | **OPEN**     |
