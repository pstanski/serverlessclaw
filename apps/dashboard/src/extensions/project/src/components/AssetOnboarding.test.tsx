...
vi.mock('@claw/ui', async (importOriginal) => {
  ...
  // Use path alias that will be resolved when this component is used in the dashboard extension
  const dashboardEn = await import('@messages/en.json').catch(() => ({ default: {} }));
