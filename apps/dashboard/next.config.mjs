...
const nextConfig = {
  ...
  // Keep tracing root at the workspace root so OpenNext can locate standalone artifacts.
  outputFileTracingRoot: fs.existsSync(path.join(__dirname, '../../../pnpm-workspace.yaml'))
    ? path.join(__dirname, '../../../')
    : path.join(__dirname, '../../'),
