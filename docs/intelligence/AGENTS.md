...
| **Strategic Planner**    | `High-Power` | **Technical Auditor**. Plans capability work, hard-fails coder dispatch errors, and keeps single-gap auto-evolution plans intact unless explicit structured subtasks are provided. See [`packages/core/agents/strategic-planner.ts`](../../packages/core/agents/strategic-planner.ts).                                                                                                                                            |
