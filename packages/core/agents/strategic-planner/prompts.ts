...
export function buildReactivePrompt(
  ...
  return `
    ...
    5. **CRITICAL**: The strategic plan MUST be highly detailed, comprehensive, and contain at least 100 characters of actionable steps, technical specifications, and numbered tasks so that downstream agents have complete instructions and the plan passes validation.
  `;
}
