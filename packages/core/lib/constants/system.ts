...
export const SYSTEM = {
  ...
  DEFAULT_OPENAI_MODEL: OpenAIModel.GPT_5_MINI,
  DEFAULT_BEDROCK_MODEL: BedrockModel.CLAUDE_4_6,
  DEFAULT_OPENROUTER_MODEL: OpenRouterModel.NEMOTRON_CONTENT_SAFETY,
  DEFAULT_DEEPSEEK_MODEL: DeepSeekModel.V4_FLASH,
  DEFAULT_MINIMAX_MODEL: MiniMaxModel.M3,
  ...
  DEFAULT_GITHUB_REPO: process.env.GITHUB_REPO || 'serverlessclaw/serverlessclaw',
} as const;
...
export const CONFIG_KEYS = {
  ...
  STRATEGIC_REVIEW_FREQUENCY: 'strategic_review_frequency',
  MIN_GAPS_FOR_REVIEW: 'min_gaps_for_review',
  CIRCUIT_BREAKER_THRESHOLD: 'circuit_breaker_threshold',
  CONSECUTIVE_BUILD_FAILURES: 'consecutive_build_failures',
  PROTECTED_RESOURCES: 'protected_resources',
  DEPLOY_LIMIT: 'deploy_limit',
  ESCALATION_ENABLED: 'escalation_enabled',
  PROTOCOL_FALLBACK_ENABLED: 'protocol_fallback_enabled',
