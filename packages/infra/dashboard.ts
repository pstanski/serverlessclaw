  ...
  const dashboard = new sst.aws.Nextjs('MissionControl', {
    ...
    buildCommand: `mkdir -p src/extensions/project && find src/extensions/ -mindepth 1 -maxdepth 1 ! -name 'index.ts' ! -name 'messages' ! -name 'project' -exec rm -rf {} + && ${
      extSource
        ...
        : ''
    }NODE_OPTIONS=--max-old-space-size=6144 npx open-next build && find .open-next -name "*.map" -delete && cd .open-next/server-functions/default && find . -type d -name ".aiready" -exec rm -rf {} + && find . -type d -name ".turbo" -exec rm -rf {} + && find . -type d -name "cache" -exec rm -rf {} + && rm -rf node_modules && npm install --production --no-package-lock --ignore-scripts --no-bin-links --omit=optional && find node_modules -name "*.map" -delete && rm -rf node_modules/next/dist/compiled/next-server/*.dev.js node_modules/next/dist/compiled/next-server/*.turbo.js && rm -rf node_modules/next/dist/compiled/webpack node_modules/next/dist/compiled/terser node_modules/next/dist/compiled/babel* node_modules/next/dist/compiled/@babel node_modules/next/dist/compiled/postcss* node_modules/next/dist/compiled/cssnano* node_modules/next/dist/pages node_modules/next/dist/client node_modules/next/dist/server/lib/squoosh node_modules/next/dist/compiled/react-dom-experimental node_modules/next/dist/compiled/react-server-dom-webpack-experimental node_modules/next/dist/esm node_modules/next/dist/docs node_modules/next/dist/bundle-analyzer node_modules/next/dist/next-devtools && rm -rf node_modules/sst* node_modules/playwright* node_modules/@unit-mesh node_modules/@next/swc* node_modules/@swc node_modules/typescript node_modules/prettier node_modules/eslint node_modules/puppeteer* node_modules/tree-sitter* node_modules/esbuild node_modules/@swc/core node_modules/rimraf node_modules/glob node_modules/caniuse-lite && rm -rf .git .github .husky docs makefiles scripts e2e reports apps/dashboard/src packages/*/src coverage tsconfig.tsbuildinfo`,
    server: {
